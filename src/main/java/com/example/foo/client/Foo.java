  ...
  public void onModuleLoad() {
    ...
    class MyHandler implements ClickHandler, KeyUpHandler {
      ...
      private void sendNameToServer() {
        ...
        GWT.log("before calling remote service with: " + textToServer);
    ...
    final String htmlContent = "<sl-button variant='primary' onclick='alert(\"Bottoncino premuto!\")'>Clicca me</sl-button>";
    HTMLPanel panel = new HTMLPanel(htmlContent);
